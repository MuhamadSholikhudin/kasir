<div class="min-height-200px">
    ...
    <div class="  border-radius-4  mb-30">
        ...
        <div class="card-box mb-30">
            <div class="pd-10 ">
                <a class="btn btn-primary" href="<?= base_url('pemilik/user/tambah') ?>" role="button">Tambah Jenis Barang</a>
            </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                        <a class="dropdown-item" href="<?= base_url('pemilik/user/lihat/') . $usr->id_user ?>"><i class="dw dw-eye"></i> Lihat</a>
                                                        <a class="dropdown-item" href="<?= base_url('pemilik/user/edit/') . $usr->id_user ?>"><i class="dw dw-edit2"></i> Ubah</a>
                                                        <a class="dropdown-item" href="<?= base_url('pemilik/user/hapus/') . $usr->id_user ?>"><i class="dw dw-delete-3"></i> Hapus</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
