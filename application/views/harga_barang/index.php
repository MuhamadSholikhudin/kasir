<div class="min-height-200px">
    ...
    <div class="  border-radius-4  mb-30">
        ...
        <div class="card-box mb-30">
            <div class="pd-10 ">
                <a class="btn btn-primary" href="<?= base_url('pemilik/harga_barang/tambah') ?>" role="button">Tambah Jenis Barang</a>
            </div>
            <div class="pd-2 text-center">
                <h4 class="text-blue h4 ">Data Kategori Harga</h4>
            </div>
            <div class="pb-20">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="data-table table table-responsive stripe hover nowrap dataTable no-footer dtr-inline" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                <thead>
                                    <tr role="row">
                                        <!-- <th class="table-plus datatable-nosort sorting_asc" rowspan="1" colspan="1" aria-label="Name">Id harga_barang</th> -->
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending">Id Barang</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending">Harga Barang</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending">Harga ambil</th>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a class="dropdown-item" href="<?= base_url('pemilik/harga_barang/lihat') ?>"><i class="dw dw-eye"></i> Lihat</a>
                                                    <a class="dropdown-item" href="<?= base_url('pemilik/harga_barang/edit') ?>"><i class="dw dw-edit2"></i> Ubah</a>
                                                    <a class="dropdown-item" href="<?= base_url('pemilik/harga_barang/hapus') ?>"><i class="dw dw-delete-3"></i> Hapus</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
